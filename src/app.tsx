...
export function App() {
  ...
  function onNoteCreated(content: string) {
    ...
    setNotes(notesArray); // cria novo array e add nova nota. newNote esta no começo para organizar por data
    ...
    <div className="mx-auto max-w-6xl my-12 space-y-6">
      ...
      <div className="grid grid-cols-3 gap-6 auto-rows-[250px]">
        ...
        {filteredNotes.map((note) => {
          return <NoteCard key={note.id} note={note} />; //key propriedade do react
        })}
      </div>
    </div>
  );
